...
function FilaProducto({ producto, agregado, bloqueada, expandida, onTogglePress, onAgregar }) {
  ...
  return (
    <View style={[styles.fila, bloqueada && styles.filaBloqueada, expandida && styles.filaActiva]}>
      ...
      <TouchableOpacity
        style={[styles.botonAgregar, (agregado || !puedeAgregar || bloqueada) && styles.botonAgregarHecho]}
        onPress={handleAgregar}
        disabled={agregado || !puedeAgregar || bloqueada}
        activeOpacity={0.85}
      >
  ...
  return (
    <View style={styles.formularioPersonalizado}>
      ...
      <View style={styles.formularioBotones}>
        <TouchableOpacity style={styles.formularioBotonCancelar} onPress={onCancelar} activeOpacity={0.8}>
          <Text style={styles.formularioBotonCancelarTexto}>Cancelar</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.formularioBotonConfirmar, !puedeAgregar && styles.formularioBotonConfirmarDeshabilitado]}
...
export default function AgregarInsumoModal({ visible, onClose }) {
  ...
  function handleAgregar(producto, { diluciones, rendimiento, capacidadTotal, capacidadUnidad, precioCompra, cantidadActual }) {
    agregarInsumo({
  ...
  function handleAgregarPersonalizado(valores) {
    agregarInsumo({
      productoId: null,
      marca: valores.marca,
