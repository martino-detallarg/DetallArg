...
│   ├── patente.js                 # normalizarPatente/validarPatente/formatearPatente: acepta formato viejo (3 letras + 3 números) y Mercosur (2 letras + 3 números + 1 letra), usado por VehiculosClienteModal.js y DatosVehiculoStep.js (wizard de Cliente nuevo)
